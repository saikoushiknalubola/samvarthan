      ...
      <footer className="border-t border-border/40 bg-card/50 backdrop-blur-sm mt-16 sm:mt-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
          <div className="flex flex-col gap-6">
            ...
            {/* Bottom Row - Developer Credits with Premium Design */}
            <div className="flex flex-col gap-6">
              {/* Team Chakra Section */}
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pb-4 border-b border-border/40">
                <p className="text-sm font-semibold text-foreground">Developed by Team Chakra</p>
                <div className="flex items-center gap-3">
                  <img 
                    src="https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/document-uploads/team-chakra-1759712744400.jpeg"
              ...
              <motion.div 
                className="flex flex-col sm:flex-row items-center justify-center gap-4 rounded-xl bg-gradient-to-br from-primary/5 to-emerald-50/50 border-2 border-primary/20 p-5 shadow-lg"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.6 }}
              >
                <div className="flex items-center gap-3">
                  <motion.div 
                    className="h-12 w-12 rounded-full bg-gradient-to-br from-primary to-emerald-600 flex items-center justify-center shadow-lg ring-2 ring-primary/30"
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-base font-bold text-primary">Saikoushik Nalubola</p>
                  </div>
                </div>
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Button
                    ...
                    variant="default"
                    size="sm"
                    className="shadow-lg hover:shadow-xl transition-all gap-2 bg-[#0A66C2] hover:bg-[#004182] text-white border-none"
                  >
                    <a 
